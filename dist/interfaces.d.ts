 ...
 */
export declare enum PromptFormat {
...
export interface PromptFactory {
    ...
    fromFormat(format: PromptFormat, content: string | Record<string, any>, options?: PromptConversionOptions): MutablePrompt;
...
export interface PromptService {
    ...
    deletePrompt(id: string, version?: number): Promise<boolean>;
    listPromptVersions(id: string): Promise<number[]>;
    applyTemplate(id: string, variables: TemplateVariables, version?: number): Promise<ApplyTemplateResult>;
}
